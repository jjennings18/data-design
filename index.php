...
<html lang="en">
	...
	<body>
		...
		<p>Bob is a 27 year old college graduate who enjoys the Tech world. Bob also
			...
			Albuquerque,New Mexico from Dallas,Texas. Bob enjoys computers and new modern day technonlogy
		...
		<uL>
			...
			<li>3. Search for the catagory you want to post to.</li>
			<li>4. The server will send any info it thinks it relevent to the topic typed
				the the search field. and display it through your browser</li>
			<li>5. Click Submit a text post </li>
			<li>6. The browser will dispaly a screen with fields for you to type in.</li>
